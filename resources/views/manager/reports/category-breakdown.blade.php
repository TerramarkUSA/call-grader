...
<body class="bg-[#f9fafb] min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-8 py-6">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-xl font-semibold text-gray-900">Category Breakdown</h1>
            <p class="text-sm text-gray-500">See which rubric categories are strongest and weakest</p>
        </div>
                ...
                @foreach($categoryStats as $cat)
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <div class="text-2xl font-semibold {{ $avgPercent >= 85 ? 'text-green-600' : ($avgPercent >= 70 ? 'text-blue-600' : ($avgPercent >= 50 ? 'text-yellow-600' : 'text-red-600')) }}">
