...
<body class="bg-[#f9fafb] min-h-screen">
    ...
    <div class="max-w-2xl mx-auto px-8 py-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 class="text-xl font-semibold text-gray-900 mb-6">Connect CTM Account</h2>
            ...
            <form method="POST" action="{{ route('admin.accounts.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        required
                    >
                    <p class="text-xs text-gray-500 mt-1">A friendly name to identify this office</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        required
                    >
                    <p class="text-xs text-gray-500 mt-1">Your credentials are encrypted and stored securely</p>
                </div>
